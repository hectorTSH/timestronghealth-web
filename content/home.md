# Home — live site copy (updated 2026-09-13)

## Hero
- Tagline: Promoting the kind of Health that keeps you Strong until the end of Time.
...
Time Strong Health bridges the gap between skilled rehabilitation and long-term functional fitness. Our founder, Hector Mallar, PT, DPT, CSFS, brings over a decade of experience working with active adults with movement challenges — now applied through private-pay fitness and wellness programming designed to sustain mobility, support fall-risk reduction goals, and support quality of life well beyond the episode of care. If you're looking for a trusted fitness and wellness resource for your patients post-discharge, contact us to learn more or request our provider information packet.
...
## Meet the Founder
Hector A. Mallar, PT, DPT, CSFS (Certified Senior Fitness Specialist) founded Time Strong Health after watching his own grandparents navigate the challenges of aging and movement disorders — and recognizing how few options existed between clinical rehab and going it alone.
...
Headshot: Hector Mallar, founder of Time Strong Health (`public/images/founder-headshot.png`).
